...
describe('PublishSettings', () => {
  ...
  it('selects and deselects platform when already connected', async () => {
    ...
    await waitFor(() => {
      ...
      expect(twitterButton).toHaveAttribute('data-testid', 'platform-button-twitter')
    })
  ...
  it('successfully publishes when platforms are selected', async () => {
    ...
    await waitFor(() => {
      expect(window.location.assign).toHaveBeenCalledWith('/campaigns/test-campaign-id/success')
    })
  })
