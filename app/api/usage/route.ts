  ...
  try {
    ...
    return NextResponse.json({
      ...
      usage: {
        ...
        campaignsPercentage: Math.round(((campaignsThisMonth || 0) / campaignLimit) * 100),

        // AI Tools
        aiToolsUsed: aiToolsCount || 0,
        aiToolsLimit: profile?.ai_tools_limit || 1,
        aiToolsPercentage: Math.round(((aiToolsCount || 0) / (profile?.ai_tools_limit || 1)) * 100),
        ...
        storagePercentage: Math.round((storageUsedMB / (storageLimits[currentTier] || 100)) * 100),
