              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm text-tron-cyan">
                    ...
                    <p>• 💡 <strong>Tip:</strong> Add external APIs for access to latest models like GPT-4 or Claude</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-tron-grid border border-tron-cyan/30 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  {usageData.campaignsPercentage >= 80 && (
                    <p className="text-sm text-red-600">⚠️ Approaching limit - consider upgrading</p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-tron-grid border border-tron-cyan/30 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  {usageData.aiToolsPercentage >= 100 && (
                    <p className="text-sm text-red-600">🔒 Limit reached - upgrade to add more tools</p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-tron-grid border border-tron-cyan/30 rounded-lg p-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span>{(usageData.tokensUsed || 0).toLocaleString()}</span>
                  </div>
