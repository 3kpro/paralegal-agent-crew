...
export const ERROR_MESSAGES = {
  ...
  N8N_NOT_FOUND: {
    ...
    message: 'The workflow service is not available. Please ensure n8n is running and the workflow is activated.',
    userMessage: 'The content generation service is currently unavailable. Please try again later.',
  },
  N8N_SERVER_ERROR: {
    code: 'N8N_SERVER_ERROR',
    message: 'n8n server returned an error. Check n8n logs for details.',
    userMessage: 'There was an error processing your request. Our team has been notified.',
  },
  N8N_TIMEOUT: {
    code: 'N8N_TIMEOUT',
    message: 'Request to n8n workflow timed out.',
    userMessage: 'The request took too long to process. Please try again with shorter content.',
  },
  N8N_CONNECTION_FAILED: {
    code: 'N8N_CONNECTION_FAILED',
    message: 'Could not connect to n8n service.',
    userMessage: 'Unable to connect to the content generation service. Please try again later.',
  },
  ...
  CONTENT_TOO_LONG: {
    ...
    userMessage: 'Your content is too long. Please keep it under 5000 characters.',
  },
  INVALID_STYLE: {
    code: 'INVALID_STYLE',
    message: 'Invalid style parameter',
    userMessage: 'Please select a valid style (professional, casual, or educational).',
  },
